...
Shader "Shader Forge/hologram" {
    Properties {
        ...
        _MovingTex1Color ("MovingTex1Color", Color) = (0.9862069,1,0,0)
        _MovingTex2 ("MovingTex2", 2D) = "white" {}
        _MovingTex2Color ("MovingTex2Color", Color) = (0.8639855,0.9264706,0.2793036,0)
        _OutlineColor ("OutlineColor", Color) = (0.5039672,0.4894031,0.9117647,0)
...
/// Final Color:
                ...
                return fixed4(finalColor,((node_2.g+node_10.g)+_Transparency.r));
            }
            ENDCG
        }
        Pass {
